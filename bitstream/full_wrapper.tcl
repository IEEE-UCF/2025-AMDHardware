...
xilinx.com:user:Custom_GPU1:1.0\
xilinx.com:user:Custom_Cpu1:1.0\
...
\
    ...
    CONFIG.PCW_UIPARAM_DDR_FREQ_MHZ {533.3333333333333333333} \
  ...
  # Create instance: Custom_GPU1_0, and set properties
  set Custom_GPU1_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Custom_GPU1:1.0 Custom_GPU1_0 ]

  # Create instance: Custom_Cpu1_0, and set properties
  set Custom_Cpu1_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Custom_Cpu1:1.0 Custom_Cpu1_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins Custom_Cpu1_0/Custom_Cpu2]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins Custom_GPU1_0/Custom_GPU2]
  ...
  [get_bd_pins Custom_Cpu1_0/custom_cpu2_aclk] \
  [get_bd_pins axi_interconnect_0/M02_ACLK] \
  [get_bd_pins Custom_GPU1_0/custom_gpu2_aclk] \
  ...
  [get_bd_pins Custom_Cpu1_0/custom_cpu2_aresetn] \
  [get_bd_pins axi_interconnect_0/M02_ARESETN] \
  [get_bd_pins Custom_GPU1_0/custom_gpu2_aresetn] \
  [get_bd_pins axi_interconnect_0/M03_ARESETN]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Custom_Cpu1_0/Custom_Cpu2/Custom_Cpu2_reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Custom_GPU1_0/Custom_GPU2/Custom_GPU2_reg] -force
